...
オープンソースの AI Coding Agent CLI。複数バックエンド（DeepSeek / OpenAI 互換 / 智譜 / 通義 / Kimi / ローカル Ollama）に対応し、ツール呼び出し、スキル読み込み、サブエージェント委任、コンテキスト圧縮、安全サンドボックスなどの完全な機能を備える。ターミナル上で AI とペアプログラミングできる。
...
<p align="center">WeChat でスキャンし、「Baize オープンソース協力」と明記してください</p>
